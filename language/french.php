...
$languages['french'] = array (
    ...
    "anonymous_participation_description" => "<ul>
        <li>Les applications de pistage utilsant OGN DDB afficheront la position avec un marqueur <em>anonyme</em></li>
    ...
    "no_participation_description" => "<ul>
        <li>TLes applications de pistage utilisant OGN DDB <em>n'</em>afficheront <em>pas</em> votre position</li>
